...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { body: @dish.body, name: @dish.name, user_id: @dish.user_id } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { body: @dish.body, name: @dish.name, user_id: @dish.user_id } }
